...
export const VIEWLINK_CAMERA_START_RECORDING = 4;
export const VIEWLINK_CAMERA_STOP_RECORDING = 5;
export const VIEWLINK_CAMERA_TAKE_PHOTO = 6;
//CONST_VIEWLINK_ACTION_GIMBAL_CONTROL
export const VIEWLINK_GIMBAL_MOTOR_ON = 1;
export const VIEWLINK_GIMBAL_MOTOR_OFF = 2;
export const VIEWLINK_GIMBAL_RESET = 3;
