...
import * as js_siteConfig from './js_siteConfig'
    ...
    class CTalk {
        ...
        hangup (p_sendToParty) {
            ...
            {
                this.parent.transmit( this.number, this.targetVideoTrack,{ hangup : true } );
            }
    ...
    class AndruavStream {
        ...
        get_conversation(p_number,p_targetVideoTrack) {
            ...
            v_talk.fn_set_status(v_talk,'connecting');
        ...
        onaddtrack(talk,mediaStreamEvent) {
            ...
            js_globals.fn_console_log ("WEBRTC: TRACK-muted:" + stream.getVideoTracks()[0].muted);
        ...
        {
            var me = this;
            var talk = this.get_conversation(dialconfig.number, dialconfig.targetVideoTrack);
                // Ignore if Closed
        ...
        joinStream (dialconfig) {
            js_globals.v_andruavClient.EVT_andruavSignalling = this.EVT_andruavSignalling;
            ...
            if (this.conversations[vid] != null) 
            {
                ...
                if (talk.status == 'connecting')
                {
                    ...
                    this.fn_set_status(talk,'cancelled');
        ...
        transmit( phone, channel,packet, times, time ) {
            ...
            var message = { packet : packet, channel:channel ,id : phone, number : js_globals.v_andruavClient.partyID };
       ...
       EVT_andruavSignalling (andruavUnit,p_signal)
       {
        ...
        async add_sdp_offer(p_signal) {
            ...
            try
            {
                ...
                await talk.create_answer(pc,talk);
