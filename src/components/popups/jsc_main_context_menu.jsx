                    ...
                    if ((p_andruavUnit.m_flightMode === js_andruavUnit.CONST_FLIGHT_CONTROL_GUIDED) 
                        ...
                        v_contextMenu.push(
                            <div key={'cmc1' + p_andruavUnit.partyID}  className='row'>";
                                ...
                                <div className='col-6'><p className='cursor_hand margin_zero text-primary si-07x' onClick={() =>fn_doFlyHere(p_andruavUnit.partyID, p_lat, p_lng, p_andruavUnit.m_Nav_Info.p_Location.alt_relative)}>Goto Here</p></div>
                    ...
                    if ((p_andruavUnit.m_flightMode === js_andruavUnit.CONST_FLIGHT_CONTROL_GUIDED) 
                        ...
                        v_contextMenu.push(
                            ...
                            v_contextMenu.push(
                                ...
                                <div className='col-6 p-0'><p className='cursor_hand margin_zero text-primary si-07x' onClick={() =>fn_doFlyHere(p_andruavUnit.partyID, p_lat, p_lng, p_andruavUnit.m_Nav_Info.p_Location.alt_relative)}>Goto Here</p></div>
                                <div className='col-6 p-0'><p className='al_r cursor_hand margin_zero text-primary si-07x' onClick={() =>fn_doSetHome(p_andruavUnit.partyID, p_lat, p_lng, p_andruavUnit.m_Nav_Info.p_Location.alt_abs)}>Set Home</p></div>
                            </div>);
