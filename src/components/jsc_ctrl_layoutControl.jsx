    ...
    render() {
        ...
        return (
            <div id="main_btn_group"  role="group" >
                ...
                <button type="button" id="btn_showControl" className="btn btn-primary btn-sm ctrlbtn d-none d-sm-inline bi bi-grid-1x2-fill" title='Change Screen Layout (use keys from 1 to 625)' onClick={(e) => fn_showControl(false)}><strong>{' FORM-' + v_display_mode}</strong></button>
