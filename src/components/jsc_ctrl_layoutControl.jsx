    ...
    render() {
        ...
        return (
            <div id="main_btn_group"  role="group" >
                ...
                <button type="button" id="btn_showVideo" className="btn btn-warning btn-sm ctrlbtn bi bi-camera" title='Show Video (ctrl+r)' onClick={(e) => fn_showVideoMainTab()}><strong> CAMERA</strong></button>
                <button type="button" id="btn_showControl" className="btn btn-primary btn-sm ctrlbtn d-none d-sm-inline" title='Change Screen Layout (use keys from 1 to 625)' onClick={(e) => fn_showControl(false)}><strong>{'DISPLAY-' + v_display_mode}</strong></button>
