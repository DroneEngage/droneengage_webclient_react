...
class CLASS_CTRL_P2P_IN_RANGE_NODE_INFO  extends React.Component {
    constructor(props)
    {
        super(props);
        this.state = {
...
export class CLASS_CTRL_P2P_IN_RANGE_NODEs extends React.Component {
    ...
    render () 
    {
        ...
        Object.entries(v_andruavUnit.m_P2P.m_detected_node).forEach(([partyID, inrange_node]) => {
            ...
            v_units.push( 
                    <CLASS_CTRL_P2P_IN_RANGE_NODE_INFO key={v_andruavUnit.partID+partyID+'RANGE_NODE_INFO1'}  p_unit={v_andruavUnit} p_inrange_node={inrange_node} />
                );
        });
