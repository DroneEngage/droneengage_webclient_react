...
export  class ClssCtrlUDPPoxyTelemetry   extends React.Component {
    ...
    renderUdpProxy()
    {
        ...
        let v_udp_on_off = [];
                ...
                if (v_andruavUnit.m_Telemetry.m_udpProxy_active === true)
                {
                    ...
                    if (v_andruavUnit.m_Telemetry.m_udpProxy_paused === false)
                    {
                        ...
                        v_udp_on_off.push(
                            <span key={v_andruavUnit.getPartyID() + 'pause'} title="Pause Telemetry" onClick={ (e) => this.fn_pauseTelemetry(v_andruavUnit)}>
                    ...
                    else
                    {
                        ...
                        v_udp_on_off.push(
                            <span key={v_andruavUnit.getPartyID() + 'active'} title="Activate Telemetry" onClick={ (e) => this.fn_startTelemetry(v_andruavUnit)}>
                    ...
                    v_udp_data.push(
                        <div key={v_andruavUnit.getPartyID() + 'txt'} className= {' col-12   padding_zero css_user_select_text ' + v_telemetry_lvl_class}>
        ...
        <div className= 'row padding_zero css_user_select_text'>
                            <div className = { v_telemetry_lvl_class + ' row al_l css_margin_zero'}>
                                ...
                                <p className=' rounded-3 cursor_hand textunit_w135 mb-0 ' title ='Smart Telemetry'>
