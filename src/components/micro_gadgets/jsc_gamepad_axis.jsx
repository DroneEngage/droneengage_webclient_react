        ...
        return (
            <div>
                <svg viewBox="-2.2 -2.2 4.4 4.4" width="128" height="128">
                    ...
                    <text textAnchor="middle" fill="#CCC" x="-1.8" y="0.1" fontSize="0.1">{this.props.x_label}</text>
                    <text textAnchor="middle" fill="#CCC" x="0.0" y="-1.7" fontSize="0.1">{this.props.y_label}</text>
                </svg>
            </div>
        );
    }
