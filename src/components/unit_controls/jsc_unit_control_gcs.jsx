...
export class ClssAndruavUnitGCS extends ClssAndruavUnitBase {
    ...
    render ()
    {
        ...
        return (
         <div id={v_andruavUnit.getPartyID() + "__FAKE"}  className={v_hidden + " row mb-1 mt-0 me-0 ms-0 pt-1 IsGCS_" + v_andruavUnit.m_IsGCS + " IsShutdown_" + (v_andruavUnit.m_IsShutdown  || v_andruavUnit.m_IsDisconnectedFromGCS)}>
